      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-50 p-12 flex-col items-start">
        ...
        <div className="py-10">
          <h1 className="text-4xl leading-tight font-semibold">
            ...
            {" "}and{" "}
            <span className="text-orange-500">Succeed Together</span>
          </h1>
          
          <p className="mt-6 text-gray-600 text-lg">
            Discover amazing products from fellow students and launch your own campus business. UNIA makes student entrepreneurship accessible to everyone.
          </p>

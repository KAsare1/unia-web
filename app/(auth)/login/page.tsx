      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-50 p-12 flex-col items-start">
        ...
        <div className="py-10">
          <h1 className="text-4xl leading-tight font-semibold">
            ...
            <span className="text-orange-500">Create, and Earn</span>
          </h1>
          
          <p className="mt-6 text-gray-600 text-lg">
Whether you're looking to buy unique student creations or start your own side hustle, UNIA connects you with your campus community.
          </p>

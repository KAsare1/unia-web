...
const features: FeatureCard[] = [
  {
    percentage: "100%",
    description: "Student-focused marketplace",
  },
  {
    percentage: "0% Commission",
    description: "Keep more from your sales",
  },
  {
    percentage: "24/7",
    description: "Buy and sell anytime, anywhere",
  },
  {
    percentage: "1-Click Ads",
    description: "Promote your products effortlessly",
  },
];
    ...
    <div className="w-full py-20 relative">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold mb-4">
          Built for <span className="text-[oklch(0.65_0.25_240)]">Students</span>{" "}
          Powered by Community
        </h2>
        <p className="text-muted-foreground mx-4">
          UNIA makes it easy for students to buy, sell, and advertise —
          affordable, accessible, and designed for campus life.
        </p>
      </div>
      <div
        style={{ zIndex: 10 }}
        ...
        {features.map((feature, index) => (
          <div
            ...
            className={cn(
              ...
              "before:bg-linear-to-r/[in_oklch] from-[oklch(0.65_0.25_240)] to-[oklch(0.75_0.15_240)]",
              "inset-shadow-sm"
            )}
          >

    ...
    >
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-6xl font-bold mb-4">
          ...
          <span className="text-[#3B82F6]">Love us</span>
        </h2>
        <p className="text-gray-500 max-w-2xl mx-auto">
          Everything student entrepreneurs need to sell and students need to
          shop - all in one powerful platform
        </p>
      </div>
      <div className="mt-20  grid cols-1 lg:grid-cols-5 gap-4 auto-rows-[25rem] max-w-3xl mx-auto lg:max-w-none">
        <Card className="flex relative flex-col justify-between lg:col-span-3">
          ...
          <CardContent className="absolute z-10 bottom-0">
            <CardTitle>
              Connect with students all over campus and other campuses
            </CardTitle>
            <CardDescription>
              Join a community of student entrepreneurs. Discover unique
              products from campuses across your school and expand your market
              reach beyond your university.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="flex flex-col relative justify-between lg:col-span-2">
          ...
          <CardContent className="absolute z-10 bottom-0">
            <CardTitle>Track your hustle</CardTitle>
            <CardDescription>
              See which products perform best, understand your customer base,
              and optimize your earnings with student-friendly analytics.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="flex flex-col relative justify-between lg:col-span-2 bg-transparent">
          ...
          <div className="absolute z-10 inset-x-0 bottom-0 h-[70%] bg-gradient-to-t from-white via-white to-transparent" />
          <CardContent className="absolute  z-10 bottom-0">
            <CardTitle>Made for student life</CardTitle>
            <CardDescription>
              Flexible delivery options, academic calendar sync, campus event
              integration, and peer-to-peer trust systems.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col justify-between lg:col-span-3">
          ...
          <CardContent className="h-40">
            <CardTitle>Built for busy students</CardTitle>
            <CardDescription>
              Simple, intuitive design that works between classes. List products
              in seconds, manage orders on mobile, and grow your side hustle
              effortlessly.
            </CardDescription>
          </CardContent>
        </Card>
    ...
    <div className="bg-white mx-auto m-4 rounded-[18px_18px_0px_0px] border border-[#E1E1E1] border-[0.4px] p-2 max-w-[290px] w-full shadow-[0px_37px_10px_0px_rgba(0,0,0,0.00),0px_24px_10px_0px_rgba(0,0,0,0.01),0px_13px_8px_0px_rgba(0,0,0,0.02),0px_6px_6px_0px_rgba(0,0,0,0.03),0px_1px_3px_0px_rgba(0,0,0,0.04)]">
      ...
      <div className="relative mx-auto h-[200px] w-[260px]">
        ...
        <div className="absolute bottom-16 top-0 left-0 right-0 flex items-end justify-between gap-4 h-[190px]">
          ...
          <div className="w-full h-[100%] rounded-t-[15px] bg-[linear-gradient(180deg,#60A5FA_0%,#FFF_100%),linear-gradient(90deg,#D9D9D9_0%,#737373_100%)] hover:opacity-90 cursor-pointer transition-opacity relative"></div>
        </div>
        ...
        >
          <div className="flex items-center gap-2">
            <div className="bg-[#1E40AF] text-white px-4 py-1.5 rounded-lg text-sm cursor-none hover:opacity-90 transition-opacity border border-white/40 flex items-center gap-2 shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] backdrop-blur-[6px] mix-blend-luminosity">
              Manu
        ...
        >
          <div className="flex items-center gap-2">
            <div className="bg-[#1E40AF] relative text-white px-4 py-1.5 rounded-lg text-sm cursor-none hover:opacity-90 transition-opacity border border-white/40 flex items-center gap-2 shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] backdrop-blur-[6px] mix-blend-luminosity">
    ...
    <OrbitingIcons
      ...
      orbits={[
        ...
        },
        {
          ...
          speed: 15,
          className:
            "bg-[radial-gradient(circle,rgba(249,250,251,1)_0%,rgba(147,197,253,1)_50%,rgba(96,165,250,1)_100%)]",
        },
        {
          icons: orbit1Icons,
